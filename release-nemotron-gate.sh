...
APK="$APP_HOME/dist/Nemotron-Unrestricted-1.5.0.apk"
...
aapt dump badging "$APK" | grep -q "package: name='com.michaelovsky.nemotronunrestricted.isolated' versionCode='6' versionName='1.5.0'"
