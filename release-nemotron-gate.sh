...
APK="$APP_HOME/dist/Nemotron-Unrestricted-1.4.0.apk"
...
aapt dump badging "$APK" | grep -q "package: name='com.michaelovsky.nemotronunrestricted.isolated' versionCode='5' versionName='1.4.0'"
