...
APK="$APP_HOME/dist/Nemotron-Unrestricted-1.3.0.apk"
...
aapt dump badging "$APK" | grep -q "package: name='com.michaelovsky.nemotronunrestricted.isolated' versionCode='4' versionName='1.3.0'"
