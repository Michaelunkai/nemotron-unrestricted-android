...
APK="$APP_HOME/dist/Nemotron-Unrestricted-1.6.0.apk"
...
aapt dump badging "$APK" | grep -q "package: name='com.michaelovsky.nemotronunrestricted.isolated' versionCode='7' versionName='1.6.0'"
