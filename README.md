...
The current release is v1.3.0/code 4 at `dist/Nemotron-Unrestricted-1.3.0.apk`, SHA-256 `8c54a05e40d1dec33a9b6eda19f3aec9dcd26d5ea0f8ba5b7c43a199cf4b01d2`. It preserves the completed white-GUI recovery, one-click session/thread cleanup, and removal of legacy floating controls while adding a shared, hashed all-model automation contract and the typed Android, PC, web, file, project, security, maintenance, recovery, scheduling, and release surfaces documented in `capabilities/CAPABILITY_CATALOG.md`.

Release acceptance passed the complete automated suite, off-device 945×2048 UI goldens, progress-overlay harness, source and signed-APK secret scans, package/version/signature checks, a silent in-place update, and post-update session/project preservation. The installed app was not launched or foregrounded during verification.
...
The public source repository is [Michaelunkai/nemotron-unrestricted-android](https://github.com/Michaelunkai/nemotron-unrestricted-android). The universal Android 1.3.0 APK is available from the [v1.3.0 release](https://github.com/Michaelunkai/nemotron-unrestricted-android/releases/tag/v1.3.0):

- [Download Nemotron-Unrestricted-1.3.0.apk](https://github.com/Michaelunkai/nemotron-unrestricted-android/releases/download/v1.3.0/Nemotron-Unrestricted-1.3.0.apk)
- SHA-256: `8c54a05e40d1dec33a9b6eda19f3aec9dcd26d5ea0f8ba5b7c43a199cf4b01d2`
...
codex-install dist/Nemotron-Unrestricted-1.3.0.apk \
  --package com.michaelovsky.nemotronunrestricted.isolated \
  --signer "$EXPECTED_SIGNER_SHA256" \
  --sha256 "8c54a05e40d1dec33a9b6eda19f3aec9dcd26d5ea0f8ba5b7c43a199cf4b01d2"
```
