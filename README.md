...
The current release is v1.4.0/code 5 at `dist/Nemotron-Unrestricted-1.4.0.apk`, SHA-256 `4e3aa0c48e945221167ee8314c29813a31112b756a00e40b9b188804b5f9ac42`. It preserves the completed white-GUI recovery, one-click session/thread cleanup, and zero-floating-control UI while adding durable ordered English progress, accessible native command summaries, and authority-safe defaults for every selectable model.

Release acceptance passed 343 automated tests, source validation, off-device 945×2048 UI goldens, the progress harness, source and signed-APK secret scans, package/version/signature checks, a silent install-session update, exact installed-byte readback, post-update session/project preservation, and a real private-virtual-display WebView proof. The installed app was not launched or foregrounded during verification.
...
The public source repository is [Michaelunkai/nemotron-unrestricted-android](https://github.com/Michaelunkai/nemotron-unrestricted-android). The universal Android 1.4.0 APK is available from the [v1.4.0 release](https://github.com/Michaelunkai/nemotron-unrestricted-android/releases/tag/v1.4.0):

- [Download Nemotron-Unrestricted-1.4.0.apk](https://github.com/Michaelunkai/nemotron-unrestricted-android/releases/download/v1.4.0/Nemotron-Unrestricted-1.4.0.apk)
...
codex-install dist/Nemotron-Unrestricted-1.4.0.apk \
  --package com.michaelovsky.nemotronunrestricted.isolated \
  --signer "$EXPECTED_SIGNER_SHA256" \
  --sha256 "4e3aa0c48e945221167ee8314c29813a31112b756a00e40b9b188804b5f9ac42"
```
